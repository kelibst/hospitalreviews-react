  ...
  const displayHospital = currentHospital.id ? (
    <div className="reviews my-2 py-3 col-sm-10 col-md-8 mx-auto">
      ...
      <div className="card shadow-lg border-0 reviews my-3">
        <h4 className="card-title my-3 text-center font-weight-bolder my-3 text-uppercase">
          {" "}
          Reviews
        </h4>
    ...
    <div className="error">{loading ? <Loading /> : <AlertContainer />}</div>
  );

  return <div className="container">{displayHospital}</div>;
};
